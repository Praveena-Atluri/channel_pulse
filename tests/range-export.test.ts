  ...
  series: [
    {
      ...
      points: [
        { day: "2026-01-30", estimatedRevenue: 1.25, netSubscribers: 2, views: 100, watchHours: 3.5 },
        { day: "2026-01-31", estimatedRevenue: 2, netSubscribers: -1, views: 50, watchHours: 1 },
        { day: "2026-03-01", estimatedRevenue: 0.5, netSubscribers: 1, views: 25, watchHours: 0.25 }
      ],
      totals: { estimatedRevenue: 3.75, netSubscribers: 2, views: 175, watchHours: 4.75 }
    }
  ],
...
test("buildRangeMonthlyCsv produces Excel-friendly escaped CSV", () => {
  ...
  assert.match(csv, /"Kids, ""One""",channel-1,2026-01,2026-01-30,2026-01-31,150,4\.5,1,3\.25/);
  assert.match(csv, /channel-1,2026-02,2026-02-01,2026-02-28,0,0,0,0/);
});
