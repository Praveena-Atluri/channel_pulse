...
create table if not exists youtube_monthly_channel_targets (
  ...
  short_engaged_views_target integer check (short_engaged_views_target is null or short_engaged_views_target >= 0),
  long_engaged_views_target integer check (long_engaged_views_target is null or long_engaged_views_target >= 0),
  ...
  long_average_view_percentage_target real check (long_average_view_percentage_target is null or long_average_view_percentage_target >= 0),
